...
class SaleOrder(models.Model):
    ...
    def update_sales_order_fields(self):
        sale_orders = self.search(
            []
        )  # Vous pouvez ajouter un domaine pour filtrer les commandes de vente
            ...
            for line in sale_order.order_line:
                ...
                if not production_order:
                    ...
                    if line.product_id.categ_id.name != "Vitrage":
                        ...
                        total_achat_matiere_sans_vitrage += (
                    ...
                    for move in production_order.move_raw_ids:
                        ...
                        if (
                            move.product_id.categ_id.name != "Vitrage"
                        ):  # Catégorie ou autre critère pour identifier
                            total_achat_matiere_sans_vitrage += (
            ...
            sale_order.write(
                {
                    ...
                    "so_marge_brute_reel": sale_order.amount_untaxed
                    - (total_achat_matiere_sans_vitrage + total_achat_vitrage),
                    "so_prc_marge_brute_reel": (
                        (
                    ...
                    * 100
                    if sale_order.amount_untaxed > 0
                    else 0,
                    "so_mcv_reel": sale_order.amount_untaxed
                    - (total_achat_matiere_sans_vitrage + total_achat_vitrage)
                    - sale_order.so_cout_mod_reel,  # Supposons que MCV = Marge brute
                    "so_prc_mcv_reel": (
                        (
                            sale_order.amount_untaxed
                            - (total_achat_matiere_sans_vitrage + total_achat_vitrage)
                            - sale_order.so_cout_mod_reel
                        )
                        / sale_order.amount_untaxed
                    )
                    * 100
