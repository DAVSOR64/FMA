...
class AccountMove(models.Model):
    ...
    def _sync_file(self, attachments):
        ...
        ftp_server_username = get_param('fma_supplier_invoice_export.ftp_server_username')
        ftp_server_password = get_param('fma_supplier_invoice_export.ftp_server_password')
        ftp_server_file_path = get_param('fma_supplier_invoice_export.ftp_server_file_path')
