...
class ResPartner(models.Model):
    ...
    def _get_file_content(self, partners):
        ...
        for partner in partners:
            line = ['PCC','I',partner.x_studio_code_tiers or '',partner.name or '','0',' ','N','N','N','0     ','O','D','N','N','O','N',' ','          ','0 ',' ','   ','N','N','0  ','   ','A41','   ','        ','    ',partner.name or '','                              ','                              ','0    ','                        ',(partner.invoice_ids[0].partner_id.country_id.name if partner.invoice_ids else partner.country_id.name) or '',partner.phone or '','                    ','                    ',' ',partner.x_studio_char_field_G6qIE or '','      ',' ',' ',partner.x_studio_commercial or '',partner.encours_max or '','EUR',partner.x_studio_mode_de_rglement_1 or '',' ',' ','                        ',(partner.bank_ids[0].bank_id.name if partner.bank_ids else '') or '',' ',(partner.bank_ids[0].acc_number if partner.bank_ids else '') or '',' ',' ',' ',' ',' ',' ',' ',' ',' ','   ','               ','0','0','0     ',' ',' ',' ',' ',(partner.invoice_ids[0].partner_id.zip if partner.invoice_ids else partner.zip) or '',' ','@                             ','@                       ','@                       ','@    ','@    ','@          ','@ ','@                             ','@                       ','@                       ','@    ','@    ','@          ','@ ','1','                                  ','                    ','                                  ','                    ','                                  ','                    ','NAF',' ',' ','                                                            ','        ','@        ',(partner.invoice_ids[0].partner_id.street if partner.invoice_ids else partner.street) or '',(partner.invoice_ids[0].partner_id.street2 if partner.invoice_ids else partner.street2) or '',(partner.invoice_ids[0].partner_id.state_id.name if partner.invoice_ids else partner.state_id.name) or '',partner.email or '','@                            ',(partner.invoice_ids[0].partner_id.city if partner.invoice_ids else partner.city) or '','1']
