    ...
    def _get_file_content(self, partners):
        ...
        for partner in partners:
            line = ['PCC',
                    ...
                    str(partner.encours_max).ljust(13) or '             ',
                    'EUR',
                    ...
                    '',
                    '                               ',
                    (str(partner.invoice_ids[0].partner_id.zip).ljust(20) if partner.invoice_ids else partner.zip) or '                    ',
                    '                               ',
                    '@                            ',
                    '@                        ',
                    '@                        ',
                    ...
                    '@                            ',
                    (str(partner.invoice_ids[0].partner_id.city).ljust(28) if partner.invoice_ids else str(partner.city).ljust(28)) or '                             ',
                    '00001',
                    '          ',
                    '                                                                                    ']
