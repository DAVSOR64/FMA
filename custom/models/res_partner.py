...
class ResPartner(models.Model):
    ...
    part_commercial = fields.Selection(
        [
            ...
            ('Cedric SEGUIN','Cedric SEGUIN'),
            ('Carlos DA TORRE','Carlos DA TORRE'),
            ('Cedric SANDRE','Cedric SANDRE'),
            ('Christian GUILHARD','Christian GUIHARD'),
