...
class PurchaseOrder(models.Model):
    ...
    # -------------------------------------------------------------
    # NEW: XML JANNEAU / DIAPASON (corrigé)
    # -------------------------------------------------------------
...
class PurchaseOrderLaquageLine(models.Model):
    ...
    # Champs spécifiques pour les détails de laquage (COMPLETS)
    ...
    def write(self, vals):
        ...
        self.mapped("order_id").message_post(body=message)
        return res
