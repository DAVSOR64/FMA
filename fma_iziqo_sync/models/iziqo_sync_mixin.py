...
class IziqoSyncMixin(models.AbstractModel):
    ...
    # _iziqo_identifier_param a None : identifiant non configurable, celui de
    # _iziqo_default_identifier s'applique.
    _iziqo_url_param = None
    _iziqo_identifier_param = None
    _iziqo_default_identifier = "id"
    # La collection repond-elle a un GET ? Sert au bouton « Tester l'acces a
    # l'API », qui ne teste que les collections qui l'exposent.
